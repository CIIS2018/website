<div class="container-fluid beneficio text-white pt-5 pb-5" id="pasos" >
    <div class="container pt-4">
        <section class="serv-grids">
            ...
            <div class="row">
                <br>
                <div class="col-md-6 serv-grid1">
                    <div class="inner_grid">
                        <h3 class="text-center">Paso 1</h3>
                        <br>
                        <p class="text-center">Ingresa en el siguiente enlace para inscribirse</p>
                        <div class="card-footer text-center">
                            <a href="{{  route('frontend.inscription') }}" class="btn btn-secondary">Inscribirse</a>
                        </div>
                ...
                {{--<div class="col-md-4 serv-grid2">
                    <div class="inner_grid">
                        ...
                        <br>
                        <p class="text-center">Además de tus datos personales debes subir una foto donde salga el numero de tu voucher</p>
                        <!-- <a href="#" data-toggle="modal" data-target="#myModal">Read more</a> -->
                    </div>
                </div>--}}

                <div class="col-md-6 serv-grid3">
                    <div class="inner_grid">
                        <h3 class="text-center">Paso 2</h3>
                        <br>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 a_small">
                <div class="card" style="border: none">
                    <div class="card-body">
                    <img class="img-fluid mb-3" style="width:100%" src="{{asset('images/auspicios/logo386.png')}}" alt="" class="img-fluid mb-3">
            ...
            <div class="col-lg-3 col-md-6 a_small">
                <div class="card" style="border: none">
                    <div class="card-body">
                    <img class="img-fluid mb-3" style="width:70%" src="{{asset('images/auspiciadores/graphicom.jpg')}}" alt="" class="img-fluid mb-3">
            ...
            <div class="col-lg-3 col-md-6 a_small">
                <div class="card" style="border: none">
                    <div class="card-body">
                        <img class="img-fluid mb-3" src="{{asset('images/auspicios/platinium.jpeg')}}" alt="" class="img-fluid mb-3">
