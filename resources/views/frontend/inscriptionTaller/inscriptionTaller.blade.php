...
<div class="container-fluid bg-primary" style="padding-top: 3%;padding-bottom: 3%;padding-left:15%; padding-right:15%">
    <div class="container bg-white" style="margin:0 auto;padding:5%">
        <h2 class="text-primary mb-3">Inscripción-Taller</h2>
        ...
        <form  id="inscripcion-taller" enctype="multipart/form-data" >
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 mb-2">
                    <select class="form-control" name="type_taller" id="tipo_taller">
                        <option value="defecto">ELEGIR TALLER</option>
                        <option value="Ciencias-computacion">Ciencias de la Computación</option>
                        <option value="Redes">Estándares de instalación de fibra óptica entre edificios</option>
                        <option value="robotica">Instalacion Robotica</option>
                        <option value="nav-robotica">Sistema de navegación autónoma para robótica móvil con GPS y magnetómetro</option>    
                    </select>
