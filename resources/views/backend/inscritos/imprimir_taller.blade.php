...
<hr style="margin-bottom: 0">
      ...
      <p style="
      text-align: center;font-size: 15pt;margin-bottom: 0;font-weight: bold;font-style:italic;margin-bottom:0%">TALLER</p>      
<p style="
      text-align: center;font-size: 15pt;margin-bottom: 0;font-weight: bold;font-style:italic;margin-bottom:0%">{{$datos->taller}}</p>      
      <hr style="margin-top: 0">
      @if($datos->tipo_inscripcion === 'inscrito CIIS')

      <p style="font-weight: bold">Tipo de inscripción: <span style="font-weight:normal">Inscrito al CIIS</p>

      @elseif ($datos->tipo_inscripcion==='No inscrito CIIS')

      <p style="font-weight: bold">Tipo de inscripción: <span style="font-weight:normal">No inscrito al CIIS</span></p>

      @elseif ($datos->tipo_inscripcion==='estudiante ESIS')
      <p style="font-weight: bold">Tipo de inscripción: <span style="font-weight:normal">Estudiante ESIS</span></p>
  ...
  <div style="margin-left:570px;margin-top:-690px;width:340px">
