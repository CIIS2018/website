...
Su código de inscripción es: <span style="background-color: yellow;color: red; font-weight: bold;">000{{$id}}</span>, conserve su código para la entrega de sus materiales y control de asistencia.
