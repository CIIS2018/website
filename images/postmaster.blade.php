           ...
           <div class="card-container">
              <div class="card">
                  <div class="front">
                      ...
                      <div class="content">
                          <div class="main">
                              ...
                              <p class="text-center">"Ciclo de vida de la aplicación empresarial Scop-Contable en plataforma Microsoft"</p>
                          </div>
                  ...
                  <div class="back">
                      ...
                      <div class="content">
                          <div class="main">
                              <h4 class="text-center">Ing. Wilson Calisaya</h4>
                              <p class="text-center">
                                <ul>    
           ...
           <div class="card-container">
              <div class="card">
                  ...
                  <div class="back">
                      ...
                      <div class="content">
                          <div class="main">
                              <h4 class="text-center">Mithzi Koc</h4>
                              <p class="text-center">
                                <ul>
          ...
          <div class="card-container">
              <div class="card">
                  ...
                  <div class="back">
                      ...
                      <div class="content">
                          <div class="main">
                              <h4 class="text-center">Pablo Ameri</h4>
                              <p class="text-center">
                                    <ul>
          ...
          <div class="card-container">
             <div class="card">
                 ...
                 <div class="back">
                     ...
                     <div class="content">
                         <div class="main">
                             <h4 class="text-center">Ing.Tony Liedyn Choque Ramos</h4>
                             <p class="text-center">
                                    <ul>
          ...
          <div class="card-container">
             <div class="card">
                 <div class="front">
                     ...
                     <div class="content">
                         <div class="main">
                             <h3 class="name">Eduardo Jesús Slee Ticona</h3>
                 ...
                 <div class="back">
                     ...
                     <div class="content">
                         <div class="main">
                             <h4 class="text-center">Eduardo Jesús Slee Ticona</h4>
                             <p class="text-center">
                                 <ul>
