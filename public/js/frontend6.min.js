...
$(document).ready(function (event) {
    ...
    $("#inscripcion").submit(function (event) {
        ...
        $('.statusMsg').html('');
        $('#cargado').html('<div id="load" class="loading"><img src="images/loader.gif" alt="loading" /><br/>Un momento, por favor....</div>');
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                if (msg === 'ok') {
                    ...
                    $('.statusMsg').html('<span style="font-size:18px;color:#34A853">La información ha sido enviada correctamente.Pronto te llegar el correo de confirmación</span>');
                    $('#cargado').css("display","none");
                } else {
...
// countdown Set end time
jQuery('.timer').countdown('2018/11/12 09:00:00', function(event) {
    jQuery(this).html(event.strftime('<div class="number"><span>%D</span> <span>Días</span></div><div class="number"><span>%H</span> <span>Horas </span></div> <div class="number"><span>%M</span> <span>Minutos </span></div> <div class="number"><span>%S</span> <span>Segundos</span></div><div class="clear"></div>'));
      });
      ...
      $(".get").mouseover(function() {
        $(this)
          .parent()
          .find("h1")
          .removeClass("hoverjstext2");
        $(this)
          .parent()
          .find("h1")
          .addClass("hoverjstext");
      
        $(this)
          .parent()
          .parent()
          .removeClass("hoverjs2");
        $(this)
          .parent()
          .parent()
          .addClass("hoverjs");
      ...
      $(".get").mouseout(function() {
        $(this)
          .parent()
          .find("h1")
          .removeClass("hoverjstext");
        $(this)
          .parent()
          .find("h1")
          .addClass("hoverjstext2");
